...
(function($) {
	...
	$.fn.carouFredSel.pageAnchorBuilder = function(nr) {
		...
		switch(nr){
			case 1:
			return '<li class="photo01"><a class="photo01" href="#">Hallstatt ハルシュタット</a></li>';
			break;
			case 2:
			return '<li class="photo02"><a class="photo02" href="#">St.Wolfgang ザンクト・ヴォルフガング</a></li>';
			break;
			case 3:
			return '<li class="photo03"><a class="photo03" href="#">Mondsee モントぜー</a></li>';
			break;
			case 4:
			return '<li class="photo04"><a class="photo04" href="#">St.Girugen ザンクト・ギルゲン</a></li>';
			break;
		}
	};
