...
(function($) {
	$.fn.carouFredSel = function(o) {
		...
		this.init = function(o) {
			...
			opts.wrapperleft=getItems($cfs).outerWidth(true)-($('div.caroufredsel_wrapper').width()-getItems($cfs).outerWidth(true))/2;
			...
			$cfs.bind('pause', function(e, g) {
				...
				.bind('prev', function(e, sO, nI) {
					...
					var c_itm = getCurrentItems($cfs, opts, nI),
						...
						$cfs.find('div.slideSection').fadeTo("slow", 0.4);
						//,function(){
							c_itm[0].next().fadeTo("slow", 1);
						//});
						//c_itm[0].next().next().fadeTo("slow", 0.4);
					...
					a_cfs[opts.dimentions[4]] = new_m-opts.wrapperleft-10;
					...
					$cfs.data('cfs_numItems', nI)
						...
						.css(opts.dimentions[4], -i_siz[0]-opts.wrapperleft-10)
						.animate(a_cfs, {
							duration: a_dur,
							easing	: sO.easing,
							complete: function() {
				...
				.bind('next', function(e, sO, nI) {
					...
					var c_itm = getCurrentItems($cfs, opts, nI),
						...
						/*c_itm[1].css('opacity', 0.4);
						c_itm[1].next().css('opacity',1);
						c_itm[1].next().next().css('opacity', 0.4);*/
						
						c_itm[1].fadeTo("slow", 0.4);
						c_itm[1].next().fadeTo("slow", 1);
						c_itm[1].next().next().fadeTo("slow", 0.4);
					...
					a_cfs[opts.dimentions[4]] = -i_siz[0]-opts.wrapperleft-10;

					if (opts.usePadding) {
						//a_old[opts.dimentions[6]] = l_old.data('cfs_origCssMargin') + opts.padding[3];
					...
					$cfs.data('cfs_numItems', nI)
						...
						.animate(a_cfs, {
							...
							complete: function() {
								...
								$cfs.css(opts.dimentions[4], org_m-opts.wrapperleft-10);
								
								var l_itm = getItems($cfs, ':lt('+$cfs.data('cfs_numItems')+')').appendTo($cfs).filter(':last');
								if (opts.usePadding) {
									//l_itm.css(opts.dimentions[6], l_itm.data('cfs_origCssMargin'));
								}
								//$cfs.data('cfs_newItems').css('opacity',0.4);
							}
						});
					$cfs.trigger('updatePageStatus').trigger('play', a_dur);
				})
	...
	$.fn.carouFredSel.pageAnchorBuilder = function(nr) {
		...
		switch(nr){
			case 1:
			return '<li><ul><li class="start"><a href="#"><img src="../img/Sightseeing/start.gif" alt="start" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano01.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 2:
			return '<li><ul><li class="link01"><a href="#"><img src="../img/Sightseeing/link01.gif" alt="Ⅰ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano02.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 3:
			return '<li><ul><li class="link02"><a href="#"><img src="../img/Sightseeing/link02.gif" alt="Ⅱ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano03.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 4:
			return '<li><ul><li class="link03"><a href="#"><img src="../img/Sightseeing/link03.gif" alt="Ⅲ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano04.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 5:
			return '<li><ul><li class="link04"><a href="#"><img src="../img/Sightseeing/link04.gif" alt="Ⅳ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano05.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 6:
			return '<li><ul><li class="link05"><a href="#"><img src="../img/Sightseeing/link05.gif" alt="Ⅴ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano06.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 7:
			return '<li><ul><li class="link06"><a href="#"><img src="../img/Sightseeing/link06.gif" alt="Ⅵ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano07.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 8:
			return '<li><ul><li class="link07"><a href="#"><img src="../img/Sightseeing/link07.gif" alt="Ⅶ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano08.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 9:
			return '<li><ul><li class="link08"i><a href="#"><img src="../img/Sightseeing/link08.gif" alt="Ⅷ" width="22" height="70" /></a></li><li><img src="../img/Sightseeing/piano09.gif" alt="" width="20" height="70" /></li></ul></li>';
			break;
			case 10:
			return '<li><ul><li class="link09"><a href="#"><img src="../img/Sightseeing/link09.gif" alt="Ⅸ" width="22" height="70" /></a></li></ul></li>';
			break;
		}
		//return '<a href="#"><span>'+nr+'</span><img src="../img/jewelry/icon.png" alt=""></a>';
	};
	...
	function setSizes($c, o) {
		...
		if (o.usePadding) {
			...
			$c.css(o.dimentions[4], o.padding[3]-o.wrapperleft-10);
		}
