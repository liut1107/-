...
(function($) {
		...
		this.bind_events = function() {
			$cfs.bind('pause', function(e, g) {
				...
				.bind('prev', function(e, sO, nI) {
					...
					a_cfs[opts.dimentions[4]] = new_m-433;
					...
					$cfs.data('cfs_numItems', nI)
						...
						.css(opts.dimentions[4], -i_siz[0]-433)
						.animate(a_cfs, {
							duration: a_dur,
							easing	: sO.easing,
							complete: function() {
				...
				.bind('next', function(e, sO, nI) {
					...
					a_cfs[opts.dimentions[4]] = -i_siz[0]-433;
					...
					$cfs.data('cfs_numItems', nI)
						...
						.animate(a_cfs, {
							...
							complete: function() {
								...
								$cfs.css(opts.dimentions[4], org_m-433);
	...
	function setSizes($c, o) {
		...
		if (o.usePadding) {
			...
			$c.css(o.dimentions[4], o.padding[3]-433);
		}
